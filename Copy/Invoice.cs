...
namespace Copy
{
    public class Invoice
    {
        ...
        public Invoice(string customerCode, string customerName, 
            ...
            int lastMonthNumber,int thisMonthNumber,int month, double subTotal,
        ...
        {
            Invoice invoice = new Invoice(customerCode,customerName,
                customerType,numberOfPeople,lastMonthNumber,
               thisMonthNumber,month,subTotal,envFee,vATFee,total);
